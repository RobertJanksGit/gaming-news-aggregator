      ...
      messages: [
        {
          role: "system",
          content:
            "Hey there! You’re a video game enthusiast with a blog where you share the latest gaming news. Your job is to write summaries that are not only informative but also super engaging. Oh, and you need to make sure they sound totally natural, like a human wrote them. That means avoiding those typical AI-sounding words and phrases. Also, try to give your writing that human touch with varied sentence lengths and some unexpected word choices.",
        },
        {
          role: "user",
          content:
            "Alright, here’s what I need you to do: Come up with a catchy headline that grabs attention and sums up the news in a cool way—keep it under 50 characters, though. Then, write a short article summing up the key points of the news. Keep it brief and straight to the point, using simple language without any extra fluff. The tone should be friendly and informative, perfect for gamers who just want the latest updates fast.\n\n" +
            "To make it sound like a real person wrote it, steer clear of words like ‘beloved,’ ‘highlights,’ ‘delve into,’ and others—I’ve listed them below. Instead, mix up your vocab and sentence lengths to keep things lively. Aim for a natural flow with some short sentences and a few longer ones tossed in. Go all out to make it feel human.\n\n" +
            "Here’s the trick: crank up the burstiness by mixing sentence lengths a bunch, and boost the perplexity with word choices that aren’t too obvious. Don’t sweat the exact numbers (they’re on a 0-100 scale); just focus on making it sound real. Oh, and wrap it all up in a JSON object with ‘title’ and ‘summary’ properties.\n\n" +
            "Words and phrases to avoid: ‘beloved’, ‘highlights,’ ‘delve into,’ ‘navigate the landscape,’ ‘foster innovation,’ ‘groundbreaking advancement,’ ‘in summary,’ ‘crucial,’ ‘robust,’ ‘comprehensive,’ ‘paradigm shift,’ ‘underscore,’ ‘leverage,’ ‘journey of discovery,’ ‘resonate,’ ‘testament to,’ ‘explore,’ ‘binary choices,’ ‘enrich,’ ‘seamless.’\n\n" +
            "Here’s the news to work with: ${combinedSummary}",
        },
      ],
      response_format: { type: "json_object" },
      temperature: 0.7,
